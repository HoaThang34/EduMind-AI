...
def test_main_subject_override_language(blocks_data):
    """Ngôn ngữ Trung (D01: Toán-Văn-Anh): preferred='Trung' không trong D01 → fallback main=Toán."""
    from seed_major_weights import derive_weights
    ...
    # Rule 'ngôn ngữ trung' → 'Trung' nhưng 'Trung' không trong D01 subjects → giữ default main = Toán
    assert by_subj['Toán']['weight'] == 0.45
